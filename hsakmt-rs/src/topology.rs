...
impl HsakmtGlobals {
    ...
    pub fn hsakmt_get_device_id_by_node_id(&self, node_id: u32) -> u16 {
        // println!("topology.g_system.NumNodes {}", self.topology.g_system.NumNodes);
        // if self.topology.g_system.NumNodes <= node_id {
        //     return 0;
        // }

        self.topology.g_props[node_id as usize].node.DeviceId
    }
}
